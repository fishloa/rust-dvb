...
|---|---|---|---|---|---|---|
| 0 | Reserved |  |  |  |  |  |
| 6 | Completed | Receivers shall treat the transmission of item of content as being completed. It is |  |  |  |  |
...
| 0x01 | CRID references the item of content that this |
|  | event is an instance of. |
| 0x02 | CRID references a series that this event |
|  | belongs to. |
