# Character Table 0A — Latin No. 8 Celtic (ISO/IEC 8859-14)
...
Latin alphabet No. 8 (Celtic). Prefix byte 0x0A.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 0A | `0x0A` (or `0x10 0x00 0x0A` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x0A`.
