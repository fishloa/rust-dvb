# Character Table 05 — Latin No. 5 (ISO/IEC 8859-9)
...
Latin alphabet No. 5 (Turkish). Prefix byte 0x05.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 05 | `0x05` (or `0x10 0x00 0x05` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x05`.
