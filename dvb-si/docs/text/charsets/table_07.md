# Character Table 07 — Latin/Thai (ISO/IEC 8859-11)
...
Latin/Thai. Prefix byte 0x07. Draft standard only.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 07 | `0x07` (or `0x10 0x00 0x07` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x07`.
