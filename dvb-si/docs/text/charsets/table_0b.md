# Character Table 0B — Latin No. 9 (ISO/IEC 8859-15)
...
Latin alphabet No. 9 (includes Euro sign). Prefix byte 0x0B.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 0B | `0x0B` (or `0x10 0x00 0x0B` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x0B`.
