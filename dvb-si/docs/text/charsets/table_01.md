# Character Table 01 — Latin/Cyrillic (ISO/IEC 8859-5)
...
Latin/Cyrillic alphabet. Prefix byte 0x01. Used for Russian, Bulgarian, Serbian (in Latin script), etc.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 01 | `0x01` (or `0x10 0x00 0x01` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x01`.
