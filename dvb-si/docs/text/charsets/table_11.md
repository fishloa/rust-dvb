# Character Table 11 — Unicode BMP (ISO/IEC 10646 UCS-2 BE)
...
Universal character set, Basic Multilingual Plane. Prefix byte 0x11. 2 bytes per character, big-endian.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 11 | `0x11` (or `0x10 0x00 0x11` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x11`.
