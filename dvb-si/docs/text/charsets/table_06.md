# Character Table 06 — Latin No. 6 (ISO/IEC 8859-10)
...
Latin alphabet No. 6 (Nordic). Prefix byte 0x06.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 06 | `0x06` (or `0x10 0x00 0x06` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x06`.
