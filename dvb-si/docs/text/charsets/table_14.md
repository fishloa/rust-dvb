# Character Table 14 — Traditional Chinese Big5 (ISO/IEC 10646 subset)
...
Traditional Chinese character set. Prefix byte 0x14.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 14 | `0x14` (or `0x10 0x00 0x14` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x14`.
