# Character Table 03 — Latin/Greek (ISO/IEC 8859-7)
...
Latin/Greek alphabet. Prefix byte 0x03. Used for Greek.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 03 | `0x03` (or `0x10 0x00 0x03` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x03`.
