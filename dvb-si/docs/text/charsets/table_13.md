# Character Table 13 — Simplified Chinese (GB-2312-1980)
...
Simplified Chinese character set. Prefix byte 0x13.

## Prefix bytes

| Table | Prefix |
|---|---|
| Table 13 | `0x13` (or `0x10 0x00 0x13` for ISO 8859 variant) |

## Usage in DVB SI

Text fields in DVB SI that use this character table begin with prefix byte `0x13`.
