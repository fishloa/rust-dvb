...
| 0b11 | Redistribution over the Internet is not allowed with the following exception: Redistribution over the Internet within a managed domain is enabled after a specified long (possibly indefinite) period of time. |
...
| 0x20 | HEVC UHD digital television service (see note 5) |
...
<!-- Auto-transcription put Table 117's content under Table 116 and dropped Table 116; reconstructed verbatim from the PDF (2026-06-12). -->

| C2_tuning_frequency_type | Description |
|---|---|
...
|---|---|
| 0b000 | 448 μs (4k Fast Fourier Transform (FFT) mode for 8 MHz Cable Television (CATV) systems) |
| 0b001 | 597,33 μs (4k FFT mode for 6 MHz CATV systems) |
...
| 0b010 | 16QAM, hierarchical, α = 1 |
| 0b011 | 16QAM, hierarchical, α = 2 |
| 0b100 | 16QAM, hierarchical, α = 3 |
| 0b101 to 0b111 | reserved for future use |
