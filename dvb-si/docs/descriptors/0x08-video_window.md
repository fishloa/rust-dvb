# Video Window (tag 0x08)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x08-video_window.rs`
**Rust struct:** `VideoWindowDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for video_window_descriptor_
