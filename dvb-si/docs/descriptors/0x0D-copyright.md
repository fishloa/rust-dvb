...
**Parser file:** `crates/dvb_si/src/descriptors/0x0D-copyright.rs`
**Rust struct:** `CopyrightDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for copyright_descriptor_
