# Data Stream Alignment (tag 0x06)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x06-data_stream_alignment.rs`
**Rust struct:** `DataStreamAlignmentDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for data_stream_alignment_descriptor_
