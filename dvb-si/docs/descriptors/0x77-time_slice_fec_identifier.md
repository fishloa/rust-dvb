# Time Slice Fec Identifier (tag 0x77)

**Spec:** ETSI EN 300 468 v1.19.1 §6.1
**Parser file:** `crates/dvb_si/src/descriptors/0x77-time_slice_fec_identifier.rs`
**Rust struct:** `TimeSliceFecIdentifierDescriptor<'a>`
