# Video Stream (tag 0x02)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x02-video_stream.rs`
**Rust struct:** `VideoStreamDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for video_stream_descriptor_
