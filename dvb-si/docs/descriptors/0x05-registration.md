...
**Parser file:** `crates/dvb_si/src/descriptors/0x05-registration.rs`
**Rust struct:** `RegistrationDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for registration_descriptor_
