...
**Parser file:** `crates/dvb_si/src/descriptors/0x04-hierarchy.rs`
**Rust struct:** `HierarchyDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for hierarchy_descriptor_
