# Dts Neural (extension sub-tag 0x0F)

**Spec:** ETSI EN 300 468 v1.19.1 §G.3
**Parser file:** `crates/dvb_si/src/descriptors/extension/0x0F-dts_neural.rs`
**Rust struct:** `DtsNeuralDescriptor<'a>`
