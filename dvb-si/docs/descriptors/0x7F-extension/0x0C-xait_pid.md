# Xait Pid (extension sub-tag 0x0C)

**Spec:** ETSI EN 300 468 v1.19.1 §F
**Parser file:** `crates/dvb_si/src/descriptors/extension/0x0C-xait_pid.rs`
**Rust struct:** `XaitPidDescriptor<'a>`
