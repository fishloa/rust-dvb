# System Clock (tag 0x0B)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x0B-system_clock.rs`
**Rust struct:** `SystemClockDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for system_clock_descriptor_
