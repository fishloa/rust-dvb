...
**Parser file:** `crates/dvb_si/src/descriptors/0x12-ibp.rs`
**Rust struct:** `IbpDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for IBP_descriptor_
