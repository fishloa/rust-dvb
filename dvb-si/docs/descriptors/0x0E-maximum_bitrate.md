# Maximum Bitrate (tag 0x0E)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x0E-maximum_bitrate.rs`
**Rust struct:** `MaximumBitrateDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for maximum_bitrate_descriptor_
