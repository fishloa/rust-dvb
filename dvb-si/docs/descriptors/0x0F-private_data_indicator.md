# Private Data Indicator (tag 0x0F)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x0F-private_data_indicator.rs`
**Rust struct:** `PrivateDataIndicatorDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for private_data_indicator_descriptor_
