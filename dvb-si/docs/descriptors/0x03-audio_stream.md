# Audio Stream (tag 0x03)

**Spec:** ETSI EN 300 468 v1.19.1 ISO/IEC 13818-1
**Parser file:** `crates/dvb_si/src/descriptors/0x03-audio_stream.rs`
**Rust struct:** `AudioStreamDescriptor<'a>`

## Purpose

_TODO: extract purpose from spec for audio_stream_descriptor_
